...
namespace Slack.NetStandard.Annotations.Tests.Examples
{
    public partial class Example
    {
        ...
        private class RespondToUrlVerificationHandler : SlackEventHandler<UrlVerification, object>
        {
            ...
            internal RespondToUrlVerificationHandler(Example wrapper)
            {
                _wrapper = wrapper;
            }

            public override Task<object> Handle(SlackContext context) => _wrapper.RespondToUrlVerification((UrlVerification)context.Event);
        }
